...
public class NotificationCenter {
  ...
  public void AddObserver(Handler handler, string notificationName, System.Object sender = null) {
    if (handler == null) {
      Debug.LogError("Can't ad a null event handler for notification, " + notificationName);
      return;
    }
  ...
  public void RemoveObserver(Handler handler, string notificationName, System.Object sender = null) {
    ...
    if (!_table.ContainsKey(notificationName)) return;
  ...
  public void Clean() {
    ...
    for (int i = notKeys.Length - 1; i >= 0; i--) {
      ...
      if (senderTable.Count == 0) _table.Remove(notificationName);
    }
  }

  public void PostNotification(string notificationName, System.Object sender = null, System.Object e = null) {
    if (string.IsNullOrEmpty(notificationName)) {
